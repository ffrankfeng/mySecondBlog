...
<body style="background-color: rgb(240,242,245);height: 750px;">
<script>
    ! function() {
        //封装方法，压缩之后减少文件大小
	...
	<div class="container" style="margin-top:2%;">
			<div class="row" style="margin-top: 1%;" >
				...
				<div class="col-lg-5 col-xs-12"align="center"style="border-radius:10px;background-color: rgba(250,250,250,0.7);text-align: center;font-size: 200%;">
