...
<script>
	...
	<div class="container"style="margin-top:2%;">
			...
			<div class="col-lg-3 hidden-xs"style="height: 800px;border-bottom: 1px solid #C5C5C5;background-color: white;margin-right: 45px;" id="profilebar"></div>
				<div class="col-lg-8 col-xs-12" style="background-color: white;" id="myariclebar">
					...
					<c:forEach items="${page.rows }" var="article">
						...
						<div class="row" style="background-color:white;height: 145px;border-bottom:1px solid #C5C5C5;">
							<div class="clo-lg-12" style="margin-top:2%;margin-left: 2%;">
								...
								<div class="col-lg" style="height:30px ;color: #808080;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
									${article.content}
								</div>
					...
					<div class="col-md-12 text-right">
						<fengf:page url="${pageContext.request.contextPath }/myarticles" />
					</div>
				</div>
			</div>
		</div>
