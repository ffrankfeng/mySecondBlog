				...
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<c:if test="${empty current_user }">
							<a class="navbar-brand hidden-lg" href="login"><img src="<%=basePath%>img/person.png" style="width: 18px;height: 18px;" /></a>
						</c:if>
						<c:if test="${!empty current_user }">
							<a class="navbar-brand hidden-lg" href="personcenter"><img src="<%=basePath%>img/person.png" style="width: 18px;height: 18px;" /></a>
						</c:if>
