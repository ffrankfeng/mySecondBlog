...
%>
    ...
    *margin-left: 0;
    ...
    if(confirm("确定不再关注ta？")){
    console.log("aasdkasjdjkasjdk==="+authorId);
    alert(authorId);
    $.post(
    ...
    <c:if test="${articlelike == null}">
        ...
        <span id="thumbsup" style="font-size: large;"><a onclick="likeAndDislike(${article.articleId },true)"><img
        src="<%=basePath%>img/like3.png" style="width: 30px;height: 30px;" onclick="" /></a>
        &emsp;${article.likecount }</span>
        </div>
        <div class="col-lg-3 col-xs-3" style=" vertical-align: middle;">
        <span id="disthumbsup" style="font-size: large;"><a onclick="likeAndDislike(${article.articleId },false)"><img
        src="<%=basePath%>img/dislike.png" style="width: 30px;height: 30px;"/></a>
