	...
	<div class="row" style="">
		...
		<div class="col-lg-12 col-xs-12" style="margin-top: 4%; height: 70px;background-color: rgba(255,255,255,0.7);border-top: 1px solid #C5C5C5;border-bottom: 1px solid #C5C5C5;">
					<table class="col-lg-12 col-xs-12" style="margin-top: 2%;text-align: center;">
						<tr >
							<td><a href="myattention">关注</a></td>
							<td><a href="myfans">粉丝</a></td>
							<td><a href="mymoodshare">心情</a></td>
							<td><a href="myarticles">文章</a></td>
						</tr>
						<tr>
								<td><a href="myattention"><span>${current_user.attention }</span></a></td>
								<td><a href="myfans"><span>${current_user.fans }</span></a></td>
								<td><a href="mymoodshare"><span>${current_user.moodcount }</span></a></td>
								<td><a href="myarticles"><span>${current_user.articlecount }</span></a></td>
							</tr>
						</table>
				...
				<div class="modal-body">
					<form class="form-horizontal" id="edit_customer_form" action="personEdit" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="edit_userName" value="${current_user.userName }" name="userName" disabled>
							</div>
						</div>	
