...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		//3、设置模板文件保存的目录
		configuration.setDirectoryForTemplateLoading(new File("D:\\javaProgram\\JavaProgram4IDEA\\blogRoot\\blog\\src\\main\\webapp\\WEB-INF\\ftl"));
...
//		Writer out = new FileWriter(new File("D:/temp/JavaEE32/freemarker/hello.txt"));
		Writer out = new FileWriter(new File("C:\\Users\\asus\\Desktop\\freemarker\\student.html"));
		//8、生成静态页面
