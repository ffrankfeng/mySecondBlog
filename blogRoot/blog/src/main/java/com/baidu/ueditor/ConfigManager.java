...
//		String configContent = this.getConfigContent();
		System.out.println("this.getConfigPath()=== "+this.getConfigPath());
	...
	private String getConfigPath () {
		System.out.println("this is = "+this.parentPath + File.separator + "conf/" + ConfigManager.configFileName);
		return this.parentPath + File.separator + "conf/" + ConfigManager.configFileName;
